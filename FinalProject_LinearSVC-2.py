...
#SVM (Linear SVC) - Poly Features added
...
lsvc.fit(Z_train,y_train)
score = lsvc.score(Z_train,y_train)
...
cv_score = cross_val_score(lsvc, Z_train, y_train, cv=10)
